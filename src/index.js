...
var client = new MongoClient(process.env.REACT_APP_MONGOURI);
function start() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent(); //1. Connect with client
                    db = client.db('tennis-lesson-planner');
                ...
                case 2:
                    err_1 = _a.sent();
                    console.error('Error on server: ', err_1);
                    return [3 /*break*/, 3];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.close()]; // Closing conexion with DDBB
                case 1:
                    _a.sent(); // Closing conexion with DDBB
                    return [2 /*return*/];
            }
        });
    });
